...
function SignUp(){
    return (<div className="mission-container">
        ...
        <div className="input-group">
            <label style={DateBirth}>Date of birth:</label>
            <select >
                <option>1</option>
                <option>2</option>
                <option>3</option>
        ...
        <div className="input-group">
            <label style={Gender}>Gender:</label>
        ...
        <div className="login-link">Already have an account? <a href="./login.html">Log In</a></div>
    </div>
);}
